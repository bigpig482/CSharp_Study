...
namespace Lesson20_反射
{
    ...
    #region 知识点一 什么是程序集
    //程序集是经由编译器编译的到的，供进一步编译执行的那个中间产物
    //在Windows系统中，它一般表象为后缀为.dll(库文件) 或者是 .exe(可执行文件)的格式
    ...
    #region 知识点四 反射的作用
    //因为反射可以在程序编译后获取信息，所以它提高了程序的拓展性和灵活性
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //这3个在栈空间的地址不一样，但是指向堆空间的地址都是一样的，因为元数据只有一份
            #endregion
            ...
            obj = info3.Invoke(new object[] { 5,"12345" }) as Test;
            Console.WriteLine(obj.str);
            #endregion
            ...
            //1.先加载一个指定程序集
            Console.WriteLine("-----------------------");
            Assembly assembly = Assembly.LoadFrom("D:\\unity study\\CSharp进阶教程\\Lesson18_练习题\\bin\\Debug\\net8.0\\Lesson18_练习题");
            ...
            //通过反射 实例化一个 icon对象
            //首先先得到枚举Type 来得到可以传入的参数
            Type moveDir = assembly.GetType("Lesson18_练习题.E_Dic");
